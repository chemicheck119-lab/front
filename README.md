...
| 공모전 Live 시나리오 | 완성형 자동 흐름 구현 | 공개 합성 SSE → 실제 AI 0/2 → 합성 확인 1/2·2/2 → 실제 CAMEO 규칙 검증 |
...
`3분 완성형 시연 시작`으로 BE SSE에서 개인정보 없는 IncidentEnvelope를 받고 실제
BFF·AI 응답을 보여줍니다. 사고·시설 CAS 확인만 서버 고정
