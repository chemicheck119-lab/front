...
const COPY: Record<FullDemoStep["id"], Pick<FullDemoStep, "label" | "detail">> = {
  ...
  AI_CANDIDATES: { label: "AI 후보", detail: "초기 게이트 0/2" },
  INCIDENT_CONFIRM: { label: "사고물질", detail: "합성 1/2 검증" },
  FACILITY_CONFIRM: { label: "시설물질", detail: "합성 2/2 검증" },
  CAMEO: { label: "CAMEO", detail: "서버 규칙 실행" },
};
