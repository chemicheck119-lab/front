import { ArrowRight, BookOpenCheck, Check, ClipboardCheck, FileAudio, FileText, MapPin, ShieldCheck } from "lucide-react";
...
const featureSections = [
  ...
  { id: "brief", number: "03", label: "ACTION BRIEF", title: "확인된 사실과 다음 행동만 선명하게 보여줍니다.", text: "사고 유형, 물질 후보, 확인 상태와 공식 근거를 한 화면에 정리하고, 상황실과 현장대원이 지금 해야 할 행동을 안내합니다.", icon: ClipboardCheck },
...
function FeatureVisual({ id }: { id: string }) {
  ...
  if (id === "brief") return <div className="feature-ui brief-ui"><div className="feature-ui-bar">현장 전달 요약 <span>확인 필요</span></div><ol><li className="done"><b>✓</b> 확인된 사실 <em>2건</em></li><li className="done"><b>✓</b> 공식 근거 <em>연결됨</em></li><li className="active"><b>!</b> 사고·시설물질 CAS <em>확인 필요</em></li><li><b>○</b> 반응 위험 <em>확인 후 표시</em></li><li><b>○</b> 다음 행동 <em>현장 확인</em></li></ol></div>;
  ...
  return (
    <main className="product-page landing-v2">
      ...
      <section className="product-hero">
        ...
        <div className="product-hero-board"><div className="board-top"><span><i /> LIVE MVP</span><b>INCIDENT / HX-2409</b></div><div className="board-location"><MapPin size={15} /> 경기 화성 산업단지 인근</div><div className="board-flow"><div className="done"><Check size={14} /> 신고 접수</div><div className="done"><Check size={14} /> 음성 전사 검토</div><div className="active"><ClipboardCheck size={14} /> 현장 전달 요약</div><div><ShieldCheck size={14} /> 두 CAS 확인 대기</div></div><p className="board-note">최종 확인 전 정보는 보류 상태로 표시됩니다.</p></div>
      </section>
      <ProofStrip items={[
