...
FE의 고정 기준은 `chemicheck119-lab/back@b982674ed74fd57aad59d1c53a43a73f074d3fa3`의 `contracts/dashboard-bff-v1.openapi.json`입니다.
...
이 검사는 원본 SHA-256, 계약 버전, 정확한 10개 BFF operation, `ServiceSession` 쿠키 보안,
